...
mysql -e "GRANT ALL PRIVILEGES ON sonarqube.* TO 'sonarqube'@'bamboo.mdp.es' IDENTIFIED BY 'sonarqube';"
...
mysql -e "GRANT ALL PRIVILEGES ON confluence.* TO 'root'@'%';"
mysql -e "GRANT ALL PRIVILEGES ON confluence.* TO 'root'@'localhost';"
mysql -e "GRANT ALL PRIVILEGES ON confluence.* TO 'alm'@'%';"
mysql -e "GRANT ALL PRIVILEGES ON confluence.* TO 'alm'@'localhost';"
mysql -e "FLUSH PRIVILEGES;"